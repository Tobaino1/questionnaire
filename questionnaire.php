            ...
            <div class="panel-body">
                ...
                <form action="questionnaire_submit.php" method="post">
                    ...
                    <div class="form-group" aria-required="true">
                        ...
                        <input type="checkbox" name="age" value="15-20" class="ageCheck"
                        >
                        15-20
                    ...
                    <div class="form-group" aria-required="true">
                        ...
                        Seasonal
                        <input type="checkbox" name="how_often[]" value="Severally" class="hofCheck">
                        Severally
                    ...
                    <input type="checkbox" name="kind_of_fight[]" value="Interpretation of post">Interpretation of
                    post<br/>
                    ...
                    <br>
                    <p><label>10. How do you express that e-conflict on the social media platforms? (You may pick more
                            than
                            one)</label></p>
                    ...
                    <p align="center" style="color: blue"><strong> Section C: Causes of e-Conflict on Social
                            Media</strong>
                    </p>
                    ...
                    <p><label>14. What categories of people do you have e-conflict with regularly? (You may pick more
                            than
                            one) </label></p>
                    <input type="checkbox" name="cat_ppl_e_conflict_everyday[]" value="People you see everyday">
                    People you see everyday <br>
                    <input type="checkbox" name="cat_ppl_e_conflict_everyday[]"
                           value="People you may see, if you want to">
                    People you may see, if you want to <br>
                    <input type="checkbox" name="cat_ppl_e_conflict_everyday[]"
                           value="People you may have never met">
                    People you may have never met <br>
                    <input type="checkbox" name="cat_ppl_e_conflict_everyday[]"
                           value="People you may never meet">
                    People you may never meet<br>
                    <br>
                    ...
                    <p><label>16. If you ever meet anyone you have had conflict with online before, what are the
                            possible
                    ...
                    <input type="checkbox" name="possible_behavioral_disposition[]"
                           value="Pretend like nothing happened">
                    ...
                    <p><label>17. What determines your behavioral disposition towards this person? (You may pick more
                            than
                            one)
                            Ignore </label></p>
                    ...
                    <p style="color: blue" align="center"><strong>Section F: Social, Cultural and Spatial differentials
                            in
                            e-Conflict</strong></p>
